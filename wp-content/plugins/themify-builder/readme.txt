...
= 7.0.2 (2023.01.02) =
* Fix: Builder: Can't copy & paste modules/rows to another page
* Fix: Builder: Layout Parts inserted in hook content miss their generated stylesheet
* Fix: Builder: Menu module: Gradient styling isn't working when using transparent color

= 7.0.1 (2022.12.23) =
* New: Builder: Post module: add load more button styling options
* Fix: Builder: Global styles changes not showing live in the editor
* Fix: Builder: Vimeo thumbnail display
* FIx: Builder: Can't import from page if it has custom CSS
* Fix: Builder: First row is not accessible if there is no header
* Fix: Builder: New row button (+) do not work in Safari 
* Fix: Builder: Column % Margin CSS rules are not generated correctly 
* Fix: Builder: Captcha v2 option doesn't work
* Fix: Builder: Parallax bg image in initial viewport jump
* Fix: Builder: Jetpack and wp.com compatibility issues
* Fix: Builder: Tab: Active tab background color does not work
* Fix: Builder: Page Break pagination is wrong in Post type
* Fix: Builder: GS frontend edit UI
* Fix: Builder: Floating module panel: Text editor heading select hidden behind lightbox
* Fix: Builder: Parallax scrolling not smooth
* Fix: Builder: Video: When you enable overlay image, video is muted
* Fix: Builder: Optin subscription has console error on submit
* Fix: Builder: Code panel: last line is not visible and typing in last line jumps up
* Fix: Builder: Enchance Cloudflare Rocket Loader conflict
