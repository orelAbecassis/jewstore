	...
	if (!empty($images)) :
		...
		?>
			<li data-bg="<?php echo esc_url(themify_https_esc($img_data[0])); ?>" data-bg-alt="<?php echo esc_attr(get_post_meta($img->ID, '_wp_attachment_image_alt', TRUE)); ?>" class="normal">
			    <a href="javascript:;" rel="nofollow" class="row-slider-dot" data-index="<?php echo $i; ?>"></a>
			</li>
		<?php
	    }
	    ?>
	    	...
	    	<a href="javascript:;" rel="nofollow" class="row-slider-arrow row-slider-prev tf_hidden tf_abs_t"></a>
	    	<a href="javascript:;" rel="nofollow" class="row-slider-arrow row-slider-next tf_hidden tf_abs_t"></a>
	        </div>
	    </div>
	    <!-- /.row-bgs -->
	    <?php
