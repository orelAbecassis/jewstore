	...
	$load_more_button = array(
		...
		self::get_tab(array(
			...
			'options' => array(
				...
				self::get_line_height(' .load-more-button', 'l_h_l_m_b','h'),
				self::get_letter_spacing(' .load-more-button', 'l_s_l_m_b','h'),
				self::get_text_transform(' .load-more-button', 't_t_l_m_b','h'),
			    self::get_text_align(' .tf_load_more', 't_a_l_m_b','h'),
