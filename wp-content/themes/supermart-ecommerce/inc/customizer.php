...
function supermart_ecommerce_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('supermart_ecommerce_copyright_padding',array(
		'default' => '',
		'sanitize_callback'	=> 'supermart_ecommerce_sanitize_float'
 	));
 	$wp_customize->add_control('supermart_ecommerce_copyright_padding',array(
		'type' => 'number',
		'label' => __('Copyright Top Bottom Padding','supermart-ecommerce'),
		'section' => 'supermart_ecommerce_footer',
	));
