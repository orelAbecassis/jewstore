<?php
function wpkites_home_page_sanitize_text($input) {
    return wp_kses_post(force_balance_tags($input));
}

function wpkites_sanitize_radio($input, $setting) {
...
if (!function_exists('wpkites_sanitize_number_range')) :
         ...
         */
        function wpkites_sanitize_number_range($input, $setting) {
