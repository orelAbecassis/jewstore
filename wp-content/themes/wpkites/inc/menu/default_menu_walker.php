...
function wpkites_page_menu_args($args) {
    if (!isset($args['show_home']))
        $args['show_home'] = true;
    return $args;
}

add_filter('wp_page_menu_args', 'wpkites_page_menu_args');

function wpkites_fallback_page_menu($args = array()) {
    ...
    $list_args['title_li'] = '';
    $list_args['walker'] = new WPKites_Walker_Page_Menunu;
...
class WPKites_Walker_Page_Menunu extends Walker_Page {
