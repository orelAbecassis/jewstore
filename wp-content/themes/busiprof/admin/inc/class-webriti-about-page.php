...
if (!class_exists('busiprof_About_Page')) {
    ...
    class busiprof_About_Page {
        ...
        public function style_and_scripts($hook_suffix) {
            ...
            if ('appearance_page_busiprof-welcome' == $hook_suffix) {
        ...
        public function add_theme_info_menu() {
            ...
            $title = sprintf(esc_html__('About busiprof Theme', 'busiprof'), esc_html($theme->get('Name')), $count);
            add_theme_page(sprintf(esc_html__('Welcome to %1$s %2$s', 'busiprof'), esc_html($theme->get('Name')), esc_html($theme->get('Version'))), $title, 'edit_theme_options', 'busiprof-welcome', array($this, 'print_welcome_page'));
        }
        ...
        public function welcome_admin_notice() {
            ...
            <div class="updated notice is-dismissible">
                ...
                <p><?php echo sprintf(esc_html__("busiprof theme is installed. To take full advantage of the features this theme has to offer visit our %1\$s welcome page %2\$s", 'busiprof'), '<a href="' . esc_url(admin_url('themes.php?page=busiprof-welcome')) . '">', '</a>'); ?></p>
                <p><a href="<?php echo esc_url(admin_url('themes.php?page=busiprof-welcome')); ?>" class="button" style="text-decoration: none;"><?php esc_html_e('Get started with busiprof Lite', 'busiprof'); ?></a></p>
            </div>
            <?php
        }
