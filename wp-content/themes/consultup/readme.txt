...
consultup -Copyright 2020 consultup, themeansar.com
...
--- Version 1.5.5 ----
1. Fixed logo enable disable issue.
...
--- Version 1.7 ----
1. Added focus shift link.

--- Version 1.7.1 ----
1. Added Woocommerce zoom support.

--- Version 1.7.2 ----
1. Fixed styling issue.

--- Version 1.7.3 ----
1. Fixed calender styling issue.
...
--- Version 1.7.6 ----
1. Fixed sticky post issue.

--- Version 1.7.7 ----
1. Fixed cf7 styling issue.

--- Version 1.7.8 ----
1. Fixed img alignemnt responsive issue.

--- Version 1.7.9 ----
1. Fixed header menu responsive color issue.

--- Version 1.8 ----
1. Fixed submit button issue.

--- Version 1.8.1 ----
1. Fixed styling issue.

--- Version 1.8.2 ----
1. Fixed Gallery hight & single author issue.

--- Version 1.8.3 ----
1. Fixed Post alignement issue.

--- Version 1.8.4 ----
1. Added Gutenberg align wide support.

--- Version 1.8.5 ----
1. Fixed textwidget image issue and check WordPress 5.4 Compatiblity.

--- Version 1.8.6 ----
1. Fixed single title and break-all text issue.

--- Version 1.8.7 ----
1. Fixed styling issue.

--- Version 1.8.8 ----
1. Added selective refresh partials for header and footer.

--- Version 1.8.9 ----
1. Fixed styling issue.

--- Version 1.9 ----
1. Fixed escaping issue & added pingback Url.

--- Version 1.9.1 ----
1. Added Responsive embads support.

--- Version 1.9.2 ----
1. Remove Permalink on single featured image.

--- Version 1.9.3 ----
1. Added fa icon for post tag.

--- Version 1.9.4 ----
1. Added edit post settings.

--- Version 1.9.5 ----
1. Fixed nav menu issue.

--- Version 1.9.6 ----
1. Fixed shop page title issue.

--- Version 1.9.7 ----
1. Added frontpage logo unlink support.

--- Version 1.9.8 ----
1. Fixed core classes styling issue.

--- Version 1.9.9 ----
1. Fixed styling issue.

--- Version 1.9.9.1 ----
1. Added single post pagination.

--- Version 1.9.9.2 ----
1. Added admin customizer link.
...
--- Version 1.9.9.7 ----
1. Fixed site title color issue.

--- Version 1.9.9.8 ----
1. Fixed js issue.

--- Version 1.9.9.9 ----
1. Added Anchor tag and echo pingback URL.

--- Version 1.9.9.9.10 ----
1. Fixed escaping issue.

--- Version 1.9.9.9.11 ----
1. Fixed WP form styling issue.
...
--- Version 1.9.9.9.17 ----
1. Update Bootstrap 4
2. fixed Responsive Style Issue

--- Version 1.9.9.9.18 ----
1. fixed mobile view Style Issue

--- Version 1.9.9.9.19 ----
1. fixed woocomerce Style Issue

--- Version 1.9.9.9.20 ----
1. fixed woocomerce Style Issue

--- Version 1.9.9.9.21 ----
1. Fixed comment not showing issue on page.

--- Version 1.9.9.9.22 ----
1. Update header settings.

--- Version 1.9.9.9.23 ----
1. Fixed Sticky header settings.

--- Version 1.9.9.9.24 ----
1. Fixed footer social icon customize selective.
...
--- Version 1.9.9.9.29----
1. Added font-size change settings.
...
--- Version 1.9.9.9.32----
1. Fixed Sidebar title issue.

--- Version 1.9.9.9.33----
1. Fixed Bredcrumb overlay issue.